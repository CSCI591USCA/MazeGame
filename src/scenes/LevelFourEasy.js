...
export default class LevelFourEasy extends Phaser.Scene {
	...
	editorCreate() {
		...
		// tile_16
		const tile_16 = this.add.image(912, 700, "tile_0000");
		tile_16.scaleX = 3;
		tile_16.scaleY = 3;
		...
		// tile_23
		const tile_23 = this.add.image(1264, 700, "tile_0000");
		tile_23.scaleX = 2;
		tile_23.scaleY = 3;

		// tile_24
		const tile_24 = this.add.image(620, 650, "tile_0000");
		tile_24.scaleX = 3;
		tile_24.scaleY = 3;

		// tile_25
		const tile_25 = this.add.image(620, 598, "tile_0000");
		tile_25.scaleX = 3;
		tile_25.scaleY = 3;

		// tile_26
		const tile_26 = this.add.image(568, 650, "tile_0000");
		tile_26.scaleX = 3;
		tile_26.scaleY = 3;

		// tile_27
		const tile_27 = this.add.image(620, 546, "tile_0000");
		tile_27.scaleX = 3;
		tile_27.scaleY = 3;

		// tile_28
		const tile_28 = this.add.image(620, 494, "tile_0000");
		tile_28.scaleX = 3;
		tile_28.scaleY = 3;

		// tile_29
		const tile_29 = this.add.image(672, 494, "tile_0000");
		tile_29.scaleX = 3;
		tile_29.scaleY = 3;

		// tile_30
		const tile_30 = this.add.image(724, 494, "tile_0000");
		tile_30.scaleX = 3;
		tile_30.scaleY = 3;

		// tile_31
		const tile_31 = this.add.image(776, 494, "tile_0000");
		tile_31.scaleX = 3;
		tile_31.scaleY = 3;

		// tile_32
		const tile_32 = this.add.image(828, 494, "tile_0000");
		tile_32.scaleX = 3;
		tile_32.scaleY = 3;

		// tile_33
		const tile_33 = this.add.image(880, 494, "tile_0000");
		tile_33.scaleX = 3;
		tile_33.scaleY = 3;

		// tile_34
		const tile_34 = this.add.image(932, 494, "tile_0000");
		tile_34.scaleX = 3;
		tile_34.scaleY = 3;

		// tile_35
		const tile_35 = this.add.image(984, 494, "tile_0000");
		tile_35.scaleX = 3;
		tile_35.scaleY = 3;

		// tile_36
		const tile_36 = this.add.image(1036, 494, "tile_0000");
		tile_36.scaleX = 3;
		tile_36.scaleY = 3;

		// tile_37
		const tile_37 = this.add.image(1088, 494, "tile_0000");
		tile_37.scaleX = 3;
		tile_37.scaleY = 3;

		// tile_38
		const tile_38 = this.add.image(1255, 650, "tile_0000");
		tile_38.scaleX = 3;
		tile_38.scaleY = 3;

		// tile_39
		const tile_39 = this.add.image(441, 360, "tile_0000");
		tile_39.scaleX = 3;
		tile_39.scaleY = 3;

		// tile_40
		const tile_40 = this.add.image(389, 360, "tile_0000");
		tile_40.scaleX = 3;
		tile_40.scaleY = 3;

		// tile_41
		const tile_41 = this.add.image(337, 360, "tile_0000");
		tile_41.scaleX = 3;
		tile_41.scaleY = 3;

		// tile_42
		const tile_42 = this.add.image(285, 360, "tile_0000");
		tile_42.scaleX = 3;
		tile_42.scaleY = 3;

		// tile_43
		const tile_43 = this.add.image(233, 360, "tile_0000");
		tile_43.scaleX = 3;
		tile_43.scaleY = 3;

		// tile_44
		const tile_44 = this.add.image(181, 360, "tile_0000");
		tile_44.scaleX = 3;
		tile_44.scaleY = 3;

		// tile_45
		const tile_45 = this.add.image(129, 360, "tile_0000");
		tile_45.scaleX = 3;
		tile_45.scaleY = 3;

		// tile_46
		const tile_46 = this.add.image(77, 360, "tile_0000");
		tile_46.scaleX = 3;
		tile_46.scaleY = 3;

		// tile_47
		const tile_47 = this.add.image(25, 360, "tile_0000");
		tile_47.scaleX = 3;
		tile_47.scaleY = 3;

		// tile_48
		const tile_48 = this.add.image(485, 360, "tile_0000");
		tile_48.scaleX = 2;
		tile_48.scaleY = 3;

		// door
		const door = this.physics.add.sprite(737, 633, "Door-1");
		door.scaleX = 0.4;
		door.scaleY = 0.4;
		...
		// key
		const key = this.physics.add.image(45, 285, "New Piskel");
		key.scaleX = 0.2;
		key.scaleY = 0.2;
		...
		// player
		const player = this.physics.add.sprite(71, 671, "idlefront1");
		player.scaleX = 1.7;
		player.scaleY = 1.7;
		...
		// enemy1
		const scoutEnemy = this.physics.add.sprite(857, 674, "enemywalk1");
		scoutEnemy.scaleX = 2;
		scoutEnemy.scaleY = 2;
		...
		// enemy2
		const outlawEnemy = this.physics.add.sprite(145, 334, "enemyrun1");
