...
export default class LevelSixEasy extends Phaser.Scene {
	...
	editorCreate() {
		...
		// tile_1
		const tile_1 = this.add.image(129, 700, "tile_0000");
		tile_1.scaleX = 3;
		tile_1.scaleY = 3;
		...
		// tile_24
		const tile_24 = this.add.image(1203, 544, "tile_0000");
		tile_24.scaleX = 3;
		tile_24.scaleY = 3;

		// tile_25
		const tile_25 = this.add.image(1151, 544, "tile_0000");
		tile_25.scaleX = 3;
		tile_25.scaleY = 3;

		// tile_26
		const tile_26 = this.add.image(1255, 544, "tile_0000");
		tile_26.scaleX = 3;
		tile_26.scaleY = 3;

		// tile_27
		const tile_27 = this.add.image(1099, 544, "tile_0000");
		tile_27.scaleX = 3;
		tile_27.scaleY = 3;

		// tile_28
		const tile_28 = this.add.image(1047, 544, "tile_0000");
		tile_28.scaleX = 3;
		tile_28.scaleY = 3;

		// tile_29
		const tile_29 = this.add.image(995, 544, "tile_0000");
		tile_29.scaleX = 3;
		tile_29.scaleY = 3;

		// tile_30
		const tile_30 = this.add.image(943, 544, "tile_0000");
		tile_30.scaleX = 3;
		tile_30.scaleY = 3;

		// tile_31
		const tile_31 = this.add.image(891, 544, "tile_0000");
		tile_31.scaleX = 3;
		tile_31.scaleY = 3;

		// tile_32
		const tile_32 = this.add.image(839, 544, "tile_0000");
		tile_32.scaleX = 3;
		tile_32.scaleY = 3;

		// tile_33
		const tile_33 = this.add.image(787, 544, "tile_0000");
		tile_33.scaleX = 3;
		tile_33.scaleY = 3;

		// tile_34
		const tile_34 = this.add.image(735, 544, "tile_0000");
		tile_34.scaleX = 3;
		tile_34.scaleY = 3;

		// tile_35
		const tile_35 = this.add.image(683, 544, "tile_0000");
		tile_35.scaleX = 3;
		tile_35.scaleY = 3;

		// tile_36
		const tile_36 = this.add.image(631, 544, "tile_0000");
		tile_36.scaleX = 3;
		tile_36.scaleY = 3;

		// tile_37
		const tile_37 = this.add.image(579, 544, "tile_0000");
		tile_37.scaleX = 3;
		tile_37.scaleY = 3;

		// tile_38
		const tile_38 = this.add.image(527, 544, "tile_0000");
		tile_38.scaleX = 3;
		tile_38.scaleY = 3;

		// tile_39
		const tile_39 = this.add.image(475, 544, "tile_0000");
		tile_39.scaleX = 3;
		tile_39.scaleY = 3;

		// tile_40
		const tile_40 = this.add.image(423, 544, "tile_0000");
		tile_40.scaleX = 3;
		tile_40.scaleY = 3;

		// tile_41
		const tile_41 = this.add.image(371, 544, "tile_0000");
		tile_41.scaleX = 3;
		tile_41.scaleY = 3;

		// tile_42
		const tile_42 = this.add.image(319, 544, "tile_0000");
		tile_42.scaleX = 3;
		tile_42.scaleY = 3;

		// tile_43
		const tile_43 = this.add.image(267, 544, "tile_0000");
		tile_43.scaleX = 3;
		tile_43.scaleY = 3;

		// tile_44
		const tile_44 = this.add.image(215, 544, "tile_0000");
		tile_44.scaleX = 3;
		tile_44.scaleY = 3;

		// tile_45
		const tile_45 = this.add.image(163, 544, "tile_0000");
		tile_45.scaleX = 3;
		tile_45.scaleY = 3;

		// tile_46
		const tile_46 = this.add.image(25, 175, "tile_0000");
		tile_46.scaleX = 3;
		tile_46.scaleY = 3;

		// tile_47
		const tile_47 = this.add.image(77, 175, "tile_0000");
		tile_47.scaleX = 3;
		tile_47.scaleY = 3;

		// tile_48
		const tile_48 = this.add.image(129, 175, "tile_0000");
		tile_48.scaleX = 3;
		tile_48.scaleY = 3;

		// tile_49
		const tile_49 = this.add.image(181, 175, "tile_0000");
		tile_49.scaleX = 3;
		tile_49.scaleY = 3;

		// tile_50
		const tile_50 = this.add.image(233, 175, "tile_0000");
		tile_50.scaleX = 3;
		tile_50.scaleY = 3;

		// tile_51
		const tile_51 = this.add.image(285, 175, "tile_0000");
		tile_51.scaleX = 3;
		tile_51.scaleY = 3;

		// tile_52
		const tile_52 = this.add.image(337, 175, "tile_0000");
		tile_52.scaleX = 3;
		tile_52.scaleY = 3;

		// tile_53
		const tile_53 = this.add.image(389, 175, "tile_0000");
		tile_53.scaleX = 3;
		tile_53.scaleY = 3;

		// tile_54
		const tile_54 = this.add.image(441, 175, "tile_0000");
		tile_54.scaleX = 3;
		tile_54.scaleY = 3;

		// tile_55
		const tile_55 = this.add.image(493, 175, "tile_0000");
		tile_55.scaleX = 3;
		tile_55.scaleY = 3;

		// tile_56
		const tile_56 = this.add.image(545, 175, "tile_0000");
		tile_56.scaleX = 3;
		tile_56.scaleY = 3;

		// tile_57
		const tile_57 = this.add.image(597, 175, "tile_0000");
		tile_57.scaleX = 3;
		tile_57.scaleY = 3;

		// tile_58
		const tile_58 = this.add.image(649, 175, "tile_0000");
		tile_58.scaleX = 3;
		tile_58.scaleY = 3;

		// tile_59
		const tile_59 = this.add.image(701, 175, "tile_0000");
		tile_59.scaleX = 3;
		tile_59.scaleY = 3;

		// tile_60
		const tile_60 = this.add.image(753, 175, "tile_0000");
		tile_60.scaleX = 3;
		tile_60.scaleY = 3;

		// tile_61
		const tile_61 = this.add.image(805, 175, "tile_0000");
		tile_61.scaleX = 3;
		tile_61.scaleY = 3;

		// tile_62
		const tile_62 = this.add.image(857, 175, "tile_0000");
		tile_62.scaleX = 3;
		tile_62.scaleY = 3;

		// tile_63
		const tile_63 = this.add.image(909, 175, "tile_0000");
		tile_63.scaleX = 3;
		tile_63.scaleY = 3;

		// tile_64
		const tile_64 = this.add.image(961, 175, "tile_0000");
		tile_64.scaleX = 3;
		tile_64.scaleY = 3;

		// tile_65
		const tile_65 = this.add.image(1013, 175, "tile_0000");
		tile_65.scaleX = 3;
		tile_65.scaleY = 3;

		// door
		const door = this.physics.add.sprite(1221, 479, "Door-1");
		door.scaleX = 0.4;
		door.scaleY = 0.4;
		...
		// key
		const key = this.physics.add.image(1229, 623, "New Piskel");
		key.scaleX = 0.2;
		key.scaleY = 0.2;
		...
		// player
		const player = this.physics.add.sprite(55, 151, "idlefront1");
		player.scaleX = 1.7;
		player.scaleY = 1.7;
		...
		// enemy1
		const enemy1 = this.physics.add.sprite(460, 148, "enemywalkingright1");
		enemy1.scaleX = 2;
		enemy1.scaleY = 2;
		...
		// scoutEnemy
		const scoutEnemy = this.physics.add.sprite(495, 513, "enemywalk1");
		scoutEnemy.scaleX = 2;
		scoutEnemy.scaleY = 2;
		...
		// outlawEnemy
		const outlawEnemy = this.physics.add.sprite(848, 651, "enemyrun1");
		...
		// lists
		const ground = [tile_0000, tile, tile_1, tile_2, tile_3, tile_4, tile_5, tile_6, tile_7, tile_8, tile_9, tile_10, tile_11, tile_12, tile_13, tile_14, tile_15, tile_16, tile_17, tile_18, tile_19, tile_20, tile_21, tile_22, tile_23, tile_26, tile_24, tile_25, tile_27, tile_28, tile_29, tile_30, tile_31, tile_32, tile_33, tile_34, tile_35, tile_36, tile_37, tile_38, tile_39, tile_40, tile_41, tile_42, tile_43, tile_44, tile_45, tile_46, tile_47, tile_48, tile_49, tile_50, tile_51, tile_52, tile_53, tile_54, tile_55, tile_56, tile_57, tile_58, tile_59, tile_60, tile_61, tile_62, tile_63, tile_64, tile_65];
		const enemies = [enemy1, scoutEnemy, outlawEnemy];
...
if (!currentMusic || !currentMusic.isPlaying) {
	...
	this.bgMusic = currentMusic;
		...
		this.scoutEnemy.patrolRange = 90;  // medium platform
		this.outlawEnemy.patrolRange = 360;  // long platform

		//----- Tag enemy types -----
		this.scoutEnemy.enemyType = "scout";
		this.outlawEnemy.enemyType = "outlaw";
		...
		this.enemies.children.iterate(enemy => {
			...
			this.scoutEnemy.turnChance = 0.006;

			this.scoutEnemy.canRandomJump = true;
			this.scoutEnemy.jumpChance = 0.002;
			this.scoutEnemy.jumpPower = 260;

			// enemy3 → long floor
			this.outlawEnemy.canRandomTurn = true;
			this.outlawEnemy.turnChance = 0.009;

			this.outlawEnemy.canRandomJump = true;
			this.outlawEnemy.jumpChance = 0.004;
			this.outlawEnemy.jumpPower = 200;
