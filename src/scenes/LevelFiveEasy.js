...
export default class LevelFiveEasy extends Phaser.Scene {
	...
	editorCreate() {
		...
		// tile_13
		const tile_13 = this.add.image(701, 700, "tile_0000");
		tile_13.scaleX = 3;
		tile_13.scaleY = 3;

		// tile_14
		const tile_14 = this.add.image(753, 700, "tile_0000");
		tile_14.scaleX = 3;
		tile_14.scaleY = 3;

		// tile_15
		const tile_15 = this.add.image(805, 700, "tile_0000");
		tile_15.scaleX = 3;
		tile_15.scaleY = 3;

		// tile_16
		const tile_16 = this.add.image(857, 700, "tile_0000");
		tile_16.scaleX = 3;
		tile_16.scaleY = 3;

		// tile_17
		const tile_17 = this.add.image(909, 700, "tile_0000");
		tile_17.scaleX = 3;
		tile_17.scaleY = 3;

		// tile_18
		const tile_18 = this.add.image(961, 700, "tile_0000");
		tile_18.scaleX = 3;
		tile_18.scaleY = 3;

		// tile_19
		const tile_19 = this.add.image(1013, 700, "tile_0000");
		tile_19.scaleX = 3;
		tile_19.scaleY = 3;

		// tile_20
		const tile_20 = this.add.image(1065, 700, "tile_0000");
		tile_20.scaleX = 3;
		tile_20.scaleY = 3;

		// tile_21
		const tile_21 = this.add.image(1117, 700, "tile_0000");
		tile_21.scaleX = 3;
		tile_21.scaleY = 3;

		// tile_22
		const tile_22 = this.add.image(1169, 700, "tile_0000");
		tile_22.scaleX = 3;
		tile_22.scaleY = 3;

		// tile_23
		const tile_23 = this.add.image(1221, 700, "tile_0000");
		tile_23.scaleX = 3;
		tile_23.scaleY = 3;

		// tile_24
		const tile_24 = this.add.image(1265, 700, "tile_0000");
		tile_24.scaleX = 2;
		tile_24.scaleY = 3;

		// tile_25
		const tile_25 = this.add.image(25, 180, "tile_0000");
		tile_25.scaleX = 3;
		tile_25.scaleY = 3;

		// tile_26
		const tile_26 = this.add.image(77, 180, "tile_0000");
		tile_26.scaleX = 3;
		tile_26.scaleY = 3;

		// tile_27
		const tile_27 = this.add.image(129, 180, "tile_0000");
		tile_27.scaleX = 3;
		tile_27.scaleY = 3;

		// tile_28
		const tile_28 = this.add.image(181, 180, "tile_0000");
		tile_28.scaleX = 3;
		tile_28.scaleY = 3;

		// tile_29
		const tile_29 = this.add.image(233, 180, "tile_0000");
		tile_29.scaleX = 3;
		tile_29.scaleY = 3;

		// tile_30
		const tile_30 = this.add.image(285, 180, "tile_0000");
		tile_30.scaleX = 3;
		tile_30.scaleY = 3;

		// tile_31
		const tile_31 = this.add.image(337, 180, "tile_0000");
		tile_31.scaleX = 3;
		tile_31.scaleY = 3;

		// tile_32
		const tile_32 = this.add.image(389, 180, "tile_0000");
		tile_32.scaleX = 3;
		tile_32.scaleY = 3;

		// tile_33
		const tile_33 = this.add.image(441, 180, "tile_0000");
		tile_33.scaleX = 3;
		tile_33.scaleY = 3;

		// tile_34
		const tile_34 = this.add.image(493, 180, "tile_0000");
		tile_34.scaleX = 3;
		tile_34.scaleY = 3;

		// tile_35
		const tile_35 = this.add.image(545, 180, "tile_0000");
		tile_35.scaleX = 3;
		tile_35.scaleY = 3;

		// tile_36
		const tile_36 = this.add.image(597, 180, "tile_0000");
		tile_36.scaleX = 3;
		tile_36.scaleY = 3;

		// tile_37
		const tile_37 = this.add.image(649, 180, "tile_0000");
		tile_37.scaleX = 3;
		tile_37.scaleY = 3;

		// tile_38
		const tile_38 = this.add.image(701, 180, "tile_0000");
		tile_38.scaleX = 3;
		tile_38.scaleY = 3;

		// tile_39
		const tile_39 = this.add.image(753, 180, "tile_0000");
		tile_39.scaleX = 3;
		tile_39.scaleY = 3;

		// tile_40
		const tile_40 = this.add.image(805, 180, "tile_0000");
		tile_40.scaleX = 3;
		tile_40.scaleY = 3;

		// tile_41
		const tile_41 = this.add.image(857, 180, "tile_0000");
		tile_41.scaleX = 3;
		tile_41.scaleY = 3;

		// tile_42
		const tile_42 = this.add.image(909, 180, "tile_0000");
		tile_42.scaleX = 3;
		tile_42.scaleY = 3;

		// tile_43
		const tile_43 = this.add.image(961, 180, "tile_0000");
		tile_43.scaleX = 3;
		tile_43.scaleY = 3;

		// tile_44
		const tile_44 = this.add.image(1013, 180, "tile_0000");
		tile_44.scaleX = 3;
		tile_44.scaleY = 3;

		// tile_45
		const tile_45 = this.add.image(1065, 180, "tile_0000");
		tile_45.scaleX = 3;
		tile_45.scaleY = 3;

		// tile_46
		const tile_46 = this.add.image(780, 650, "tile_0000");
		tile_46.scaleX = 3;
		tile_46.scaleY = 3;

		// tile_47
		const tile_47 = this.add.image(780, 598, "tile_0000");
		tile_47.scaleX = 3;
		tile_47.scaleY = 3;

		// tile_48
		const tile_48 = this.add.image(780, 546, "tile_0000");
		tile_48.scaleX = 3;
		tile_48.scaleY = 3;

		// tile_49
		const tile_49 = this.add.image(832, 546, "tile_0000");
		tile_49.scaleX = 3;
		tile_49.scaleY = 3;

		// tile_50
		const tile_50 = this.add.image(884, 546, "tile_0000");
		tile_50.scaleX = 3;
		tile_50.scaleY = 3;

		// tile_51
		const tile_51 = this.add.image(936, 546, "tile_0000");
		tile_51.scaleX = 3;
		tile_51.scaleY = 3;

		// tile_52
		const tile_52 = this.add.image(988, 546, "tile_0000");
		tile_52.scaleX = 3;
		tile_52.scaleY = 3;

		// tile_53
		const tile_53 = this.add.image(1040, 546, "tile_0000");
		tile_53.scaleX = 3;
		tile_53.scaleY = 3;

		// tile_54
		const tile_54 = this.add.image(1092, 546, "tile_0000");
		tile_54.scaleX = 3;
		tile_54.scaleY = 3;

		// tile_55
		const tile_55 = this.add.image(1144, 546, "tile_0000");
		tile_55.scaleX = 3;
		tile_55.scaleY = 3;

		// tile_56
		const tile_56 = this.add.image(1196, 546, "tile_0000");
		tile_56.scaleX = 3;
		tile_56.scaleY = 3;

		// tile_57
		const tile_57 = this.add.image(1250, 546, "tile_0000");
		tile_57.scaleX = 3.5;
		tile_57.scaleY = 3;

		// tile_58
		const tile_58 = this.add.image(832, 598, "tile_0000");
		tile_58.scaleX = 3;
		tile_58.scaleY = 3;

		// tile_59
		const tile_59 = this.add.image(884, 598, "tile_0000");
		tile_59.scaleX = 3;
		tile_59.scaleY = 3;

		// tile_60
		const tile_60 = this.add.image(936, 598, "tile_0000");
		tile_60.scaleX = 3;
		tile_60.scaleY = 3;

		// tile_61
		const tile_61 = this.add.image(988, 598, "tile_0000");
		tile_61.scaleX = 3;
		tile_61.scaleY = 3;

		// tile_62
		const tile_62 = this.add.image(1040, 598, "tile_0000");
		tile_62.scaleX = 3;
		tile_62.scaleY = 3;

		// tile_63
		const tile_63 = this.add.image(1092, 598, "tile_0000");
		tile_63.scaleX = 3;
		tile_63.scaleY = 3;

		// tile_64
		const tile_64 = this.add.image(1144, 598, "tile_0000");
		tile_64.scaleX = 3;
		tile_64.scaleY = 3;

		// tile_65
		const tile_65 = this.add.image(1196, 598, "tile_0000");
		tile_65.scaleX = 3;
		tile_65.scaleY = 3;

		// tile_66
		const tile_66 = this.add.image(1250, 598, "tile_0000");
		tile_66.scaleX = 3.5;
		tile_66.scaleY = 3;

		// tile_67
		const tile_67 = this.add.image(832, 650, "tile_0000");
		tile_67.scaleX = 3;
		tile_67.scaleY = 3;

		// tile_68
		const tile_68 = this.add.image(884, 650, "tile_0000");
		tile_68.scaleX = 3;
		tile_68.scaleY = 3;

		// tile_69
		const tile_69 = this.add.image(936, 650, "tile_0000");
		tile_69.scaleX = 3;
		tile_69.scaleY = 3;

		// tile_70
		const tile_70 = this.add.image(988, 650, "tile_0000");
		tile_70.scaleX = 3;
		tile_70.scaleY = 3;

		// tile_71
		const tile_71 = this.add.image(1040, 650, "tile_0000");
		tile_71.scaleX = 3;
		tile_71.scaleY = 3;

		// tile_72
		const tile_72 = this.add.image(1092, 650, "tile_0000");
		tile_72.scaleX = 3;
		tile_72.scaleY = 3;

		// tile_73
		const tile_73 = this.add.image(1144, 650, "tile_0000");
		tile_73.scaleX = 3;
		tile_73.scaleY = 3;

		// tile_74
		const tile_74 = this.add.image(1196, 650, "tile_0000");
		tile_74.scaleX = 3;
		tile_74.scaleY = 3;

		// tile_75
		const tile_75 = this.add.image(1250, 650, "tile_0000");
		tile_75.scaleX = 3.5;
		tile_75.scaleY = 3;

		// door
		const door = this.physics.add.sprite(1224, 476, "Door-1");
		door.scaleX = 0.4;
		door.scaleY = 0.4;
		...
		// player
		const player = this.physics.add.sprite(54, 154, "idlefront1");
		player.scaleX = 1.7;
		player.scaleY = 1.7;
		...
		// key
		const key = this.physics.add.image(47, 623, "New Piskel");
		key.scaleX = 0.2;
		key.scaleY = 0.2;
	...
	create() {
		...
		this.outlawEnemy.patrolRange = 90;
		this.enemy2.patrolRange = 90;
		this.scoutEnemy.patrolRange = 360;
